...
<body>
<!-- <form  action="deactivatestartups?action=deactivatestartups" method="post" > -->
<form method="post">
...
<input type="submit" value="Deactivate" onclick="form.action='deactivateStartupStatus.htm;'"/>
